...
dagshub.init(repo_owner='anubhav1803', repo_name='mlops_project1', mlflow=True)
mlflow.set_experiment("Experiment 2")  # Set the experiment name
mlflow.set_tracking_uri("https://dagshub.com/anubhav1803/mlops_project1.mlflow")   # Registry URI for model management

# Load the dataset from CSV file and split into training and testing sets
data = pd.read_csv(r"C:\Users\anubhcha\OneDrive - Capgemini\Desktop\JN\water_potability.csv")
...
with mlflow.start_run(run_name="Water Potability Models Experiment"):
    ...
    for model_name, model in models.items():
        ...
        with mlflow.start_run(run_name=model_name, nested=True):
            ...
            mlflow.set_tag("author", "AnubhavChauhan")
